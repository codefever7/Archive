...
export default function HowConsolidationWork() {
            ...
            <div className="how-iva-work" onMouseMove={({ clientX: x, clientY: y }) => set({ xy: calc(x, y) })}>
                <Container>
                    <h2 className="heading wow fadeInUp mb-5 text-center">
                        How does <span className="bg-success"> Debt Management work?</span>
                    </h2>
                    <Row>
                        <Col lg={4}>
                        ...
                        <Col lg={4}>
                            <div className="how-work-box text-center p-4">
                                ...
                                <p className="lead lead--small wow fadeInUp">
                                    If an DMP is the best solution for you, we can start the ball rolling whenever you’re ready. We will help along the way until you become debt free!
                                </p>
                            </div>
                        </Col>
                    </Row>
